...
HD_PWD='D:/Programs Data/Vivado/ImprovedThermostat/ImprovedThermostat.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log improvedthermostat.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source improvedthermostat.tcl
